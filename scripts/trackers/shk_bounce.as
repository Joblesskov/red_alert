...
class TeslaBounce : Tracker {
	protected Metagame@ m_metagame;

	TeslaBounce(Metagame@ metagame) {
		@m_metagame = @metagame;
	}
	...
	protected void handleResultEvent(const XmlElement@ event) {
		...
		int bounce_num;
		string bounce_projectile;

		if (sourceKey == "trooper_bounce") {
			bounce_num = 2;
			bounce_projectile = "tesla_bounce.projectile";
		} else if (sourceKey == "tank_bounce") {
			return;
		} else if (sourceKey == "coil_bounce") {
			return;
		} else {
			return;
		}
